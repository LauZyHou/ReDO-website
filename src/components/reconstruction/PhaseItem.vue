  ...
  <div class="main">
    ...
    <el-tabs type="card">
      <el-tab-pane label="Structure">
        <matrix-info-chart
          :matrix="showMatrix"
          :label="changeToLabel(showMatrixLabel)"
          :rname="changeToLabelOne(showNode)"
          :labelid="showMatrixLabel"
          @detail="seeNodeDetail"
        />
      </el-tab-pane>
      <el-tab-pane label="Statistic">
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column prop="origin" label="Original Cost" width="180">
          </el-table-column>
          <el-table-column prop="refactored" label="Optimized Cost" width="180">
          </el-table-column>
          <el-table-column prop="decrease" label="Decreasing Rate">
          </el-table-column>
        </el-table>
      </el-tab-pane>
    </el-tabs>
...
export default {
  ...
  beforeMount() {
    ...
    if (this.$route.params.data != undefined) {
      ...
      this.$http
        .post(this.baseUrl + "calculate-complexity", fd, {
          headers: {
        ...
        .then((res) => {
          ...
          _this.tableData[0].decrease =
            ((_this.tableData[0].refactored - _this.tableData[0].origin) /
              _this.tableData[0].origin) *
              100 +
            "%";
        });
