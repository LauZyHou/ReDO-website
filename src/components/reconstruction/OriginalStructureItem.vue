<template>
  <div class="main" style="height: 80%; width: 92.5%">
    <div style="width: 100%">
      <p style="display: inline-block; margin-right: 5%">
        Original Cost matrix: {{ complexity }}
      </p>
