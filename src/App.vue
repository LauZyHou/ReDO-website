  ...
  <div id="app">
    <div class="intro">
      ...
      <div class="title-style">
        <p>
          <b
            >ReDO: Recommendation on Development Order based on Design Class
            Diagram</b
          >
        </p>
      </div>
...
export default {
  ...
  created() {
    var _this = this;
    this.$http
      .post(this.baseUrl + "session", null, {
        headers: {
  ...
  methods: {
    logout() {
      var _this = this;
      this.$http
        .post(this.baseUrl + "sessionOut", null, {
          headers: {
            "Content-Type": "application/x-www-form-urlencoded",
            dataType: "json",
          },
